...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/tacascer-org/xml-processor-plugin")
        licenses {
            license {
                name = "GPL-3.0"
        ...
        scm {
            url = "https://github.com/tacascer-org/xml-processor-plugin"
            connection = "scm:git:git://github.com/tacascer-org/xml-processor-plugin.git"
            developerConnection = "scm:git:ssh://git@github.com:tacascer-org/xml-processor-plugin.git"
        }
    }
}
